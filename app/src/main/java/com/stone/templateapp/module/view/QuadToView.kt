...
class QuadToView : View {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        mPath.quadTo(0f, 0f, 500f, 0f)
        canvas.drawPath(mPath, mPaint)

        mPath.rewind()
        mPath.moveTo(-500f, 0f)
        mPath.quadTo(0f, 100f, 500f, 0f)
        mPaint.color = Color.parseColor("green")
        canvas.drawPath(mPath, mPaint)
        canvas.drawPoint(0f, 100f, mPointPaint)

        mPath.rewind()
        mPath.moveTo(-500f, 0f)
        mPath.quadTo(0f, 500f, 500f, 0f)
        mPaint.color = Color.parseColor("purple")
        canvas.drawPath(mPath, mPaint)
        canvas.drawPoint(0f, 500f, mPointPaint)
